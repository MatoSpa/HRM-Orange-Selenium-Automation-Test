...
describe("Test - Contact details", function () {
    it("1.Test - Email - EP", async function () {
    ...
    it("2.Test - Email - EP", async function () {
        ...
        const email = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(9) > div > div:nth-child(1) > div > div:nth-child(2) > input')));
        await email.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await email.sendKeys("@gmail.com",Key.RETURN);
    ...
    it("3.Test - Email - EP", async function () {
        ...
        const email = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(9) > div > div:nth-child(1) > div > div:nth-child(2) > input')));
        await email.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await email.sendKeys("testgmail.com",Key.RETURN);
    ...
    it("4.Test - Email - EP", async function () {
        ...
        const email = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(9) > div > div:nth-child(1) > div > div:nth-child(2) > input')));
        await email.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await email.sendKeys("test@.com",Key.RETURN);
    ...
    it("5.Test - Email - EP", async function () {
        ...
        const email = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(9) > div > div:nth-child(1) > div > div:nth-child(2) > input')));
        await email.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await email.sendKeys("test@gmailcom",Key.RETURN);
    ...
    it("6.Test - Email - EP", async function () {
        ...
        const email = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(9) > div > div:nth-child(1) > div > div:nth-child(2) > input')));
        await email.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await email.sendKeys("test@gmail.",Key.RETURN);
