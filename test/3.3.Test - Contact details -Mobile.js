...
describe("Test - Contact details", function () {
    it("1.Test - Mobile - BVA", async function () {
        ...
        const mobileNumber = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(6) > div > div:nth-child(2) > div > div:nth-child(2) > input')));
        await mobileNumber.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await mobileNumber.sendKeys("1",Key.RETURN);

        const saveSuccssesful = await driver.wait(until.elementLocated(By.xpath('/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[2]/p[1]')));
        await driver.quit();
    });

    it("2.Test - Mobile - BVA", async function () {
        ...
        const mobileNumber = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(6) > div > div:nth-child(2) > div > div:nth-child(2) > input')));
        await mobileNumber.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await mobileNumber.sendKeys("1111111111111111111111111",Key.RETURN);
    ...
    it("3.Test - Mobile - BVA", async function () {
        ...
        const mobileNumber = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(6) > div > div:nth-child(2) > div > div:nth-child(2) > input')));
        await mobileNumber.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await mobileNumber.sendKeys("11111111111111111111111111",Key.RETURN);
    ...
    it("4.Test - Mobile - BVA", async function () {
        ...
        const mobileNumber = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(6) > div > div:nth-child(2) > div > div:nth-child(2) > input')));
        await mobileNumber.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await mobileNumber.sendKeys("+ - / ( )",Key.RETURN);
    ...
    it("5.Test - Mobile - BVA", async function () {
        ...
        const mobileNumber = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(6) > div > div:nth-child(2) > div > div:nth-child(2) > input')));
        await mobileNumber.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await mobileNumber.sendKeys("a",Key.RETURN);
    ...
    it("6.Test - Mobile - BVA", async function () {
