...
describe("Test - Contact details", function () {
    it("1.Test - Zip - BVA ", async function () {
        ...
        const zipCode = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(3) > div > div:nth-child(5) > div > div:nth-child(2) > input')));
        await zipCode.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await zipCode.sendKeys("1",Key.RETURN);

        const saveSuccssesful = await driver.wait(until.elementLocated(By.xpath('/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[2]/p[1]')));
        await driver.quit();
    });

    it("2.Test - Zip - BVA ", async function () {
        ...
        const zipCode = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(3) > div > div:nth-child(5) > div > div:nth-child(2) > input')));
        await zipCode.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await zipCode.sendKeys("1111111111",Key.RETURN);
    ...
    it("3.Test - Zip - BVA ", async function () {
        ...
        const zipCode = await driver.wait(until.elementLocated(By.css('#app > div.oxd-layout > div.oxd-layout-container > div.oxd-layout-context > div > div > div > div.orangehrm-edit-employee-content > div.orangehrm-horizontal-padding.orangehrm-vertical-padding > form > div:nth-child(3) > div > div:nth-child(5) > div > div:nth-child(2) > input')));
        await zipCode.sendKeys(Key.chord(Key.SHIFT, Key.HOME),Key.DELETE);
        await zipCode.sendKeys("11111111111",Key.RETURN);
